...
<div class="profile-grid">
    ...
    <div class="profile-card">
        ...
        <p class="member-since">
            Membre depuis <%= dateFormat.format(passager.getDateInscription()) %>
        </p>
    </div>
    ...
    <div class="forms-container">
        ...
        <div class="form-section">
            ...
            <form method="POST" action="Passager" id="formInfoPersonnelles">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="telephone" value="<%= passager.getTelephone() %>" required>
                    </div>
                </div>
        ...
        <div class="form-section">
            ...
            <form method="POST" action="Passager" id="formMotDePasse">
